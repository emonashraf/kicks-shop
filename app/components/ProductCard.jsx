    ...
    <div className="group">
      <div className="bg-[#F5F5F5] rounded-[28px] p-2 overflow-hidden ">
        ...
        <div className="relative">
          <span className="absolute top-0 left-0 bg-primary text-white text-sm font-semibold px-4 py-3 rounded-br-3xl rounded-tl-4xl z-10">{badge}</span>
          {/* Product Image */}
          <Link href={link} className="relative w-full block  overflow-hidden rounded-3xl">
      ...
      {/* Product Info */}
      <div className="mt-4">
        <h4 className=" leading-[1.17] tracking-tight transition duration-300 hover:text-primary"><Link href={link}>{title}</Link> </h4>
