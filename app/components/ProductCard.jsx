    ...
    <div className="group flex flex-col align-between">
      <div className="bg-off-white rounded-fluid-28 p-2 overflow-hidden">
        ...
        <div className="relative">
          ...
          {/* Product Image */}
          <Link href={link} className="relative w-full block  overflow-hidden rounded-fluid-24">
      ...
      <div className="mt-4">
        ...
        <Button variant="darkGray" href={link} className="w-full mt-2 md:mt-3 xl:mt-4 text-xs md:text-sm">
          {buttonText} —
